...
class RoleAdmin extends Command_1.default {
    ...
    async Run(message, args) {
        ...
        if (add && !remove) {
            ...
            return await message.channel.send('[Missing Parameter] Please specify --add OR --remove');
        }
...
exports.GenerateRoleAdmin = (name, leadRole, roleToAdd, guildId) => {
    var _a;
    return _a = class AutoGeneratedRoleAdmin extends RoleAdmin {
            constructor() {
                super(...arguments);
                this.AllowedGuilds = [guildId];
                this.Type = 'RoleAdmin';
                this.Data = {
                    Role: roleToAdd,
                    Lead: leadRole
